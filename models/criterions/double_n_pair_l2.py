...
class DoubleNPairL2(nn.Module):
    ...
    def __init__(self):
        ...
        self.regularizer = Options()['model']['criterion'].get('regularizer', 0.1)
    ...
    def forward(self, networkOutput, batch):
        ...
        loss = torch.log(expSum) + self.regularizer * torch.norm(embeddings, p=2)
