#
# Code from https://github.com/pytorch/pytorch/blob/master/benchmarks/fastrnns/custom_lstms.py
#
...
import MSEmbedding.datasets.BatchLoader as BatchLoader
...
def reverse(lst):
    ...
    # print("reverse. len(lst)={}".format(len(lst)))

    # type: (List[Tensor]) -> List[Tensor]
    
    #
    # Cannot used negative stride due to Pytorch bug: https://github.com/pytorch/pytorch/pull/33019
    #
    # return lst[::-1] 

    list_reversed = list(lst)
...
class LSTMLayer(jit.ScriptModule):
    ...
    def forward(self, input, state):
        ...
        # print("LSTMLayer. len(state)={}".format(len(state)))
...
class StackedLSTM2(jit.ScriptModule):
    ...
    def forward(self, input, states):
        ...
        # print("StackedLSTM2.forward. input.shape={}".format(input.shape))
        ...
        # print ("output.shape={}, len(output_states)={}".format(output.shape, len(output_states)))
