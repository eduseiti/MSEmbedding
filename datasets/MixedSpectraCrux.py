...
class MixedSpectraCrux(data.Dataset):
    ...
    TRAIN_EXPERIMENTS_DATA_4_3 = TRAIN_EXPERIMENTS_DATA_4_2 = TRAIN_EXPERIMENTS_DATA_4_1 = TRAIN_EXPERIMENTS_DATA_4_0
    ...
    TEST_EXPERIMENTS_DATA_4_3 = TEST_EXPERIMENTS_DATA_4_2 = TEST_EXPERIMENTS_DATA_4_1 = TEST_EXPERIMENTS_DATA_4_0
