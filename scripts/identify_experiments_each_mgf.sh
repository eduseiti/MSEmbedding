...
#
# How to use; ./identify_experiments_each_mgf.sh <experiments folders folder> 
#										<identifications destination folder> 
#										<crux executable path> 
#										<peptides identification database file> 
#										<crux parameters file>
#
# This script will call the identification tool for EACH mgf file inside each experiment.
#
#
#
